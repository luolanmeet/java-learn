 ...
 * 
 */
@WebServiceClient(name = "UserServiceService", targetNamespace = "http://service.pers/", wsdlLocation = "file:/Users/chenken/dev/project/learn/cck/java-learn/webservice/origin-webservice/client/helloWorld.wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICESERVICE_QNAME = new QName("http://service.pers/", "UserServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/Users/chenken/dev/project/learn/cck/java-learn/webservice/origin-webservice/client/helloWorld.wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://service.pers/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.pers/", "UserServicePort"), UserService.class, features);
    }
